...
function waveSubscore(waveFt, preference) {
  ...
  if (preference === "calm") {
    if (waveFt <= 1.5) return 78; if (waveFt <= 3) return 100; if (waveFt <= 4.5) return 60; if (waveFt <= 6.5) return 30; return 10;
  }
  if (preference === "rough") {
...
// catch. This is the same principle as before, just now scoped correctly.
function computeFeedingCeiling(waveFt, clarityScore) {
  let ceiling = 98;
  if (waveFt != null) { if (waveFt > 6) ceiling = 55; else if (waveFt > 4.5) ceiling = 75; }
  if (clarityScore != null && clarityScore < 30) ceiling = Math.min(ceiling, 60);
  return ceiling;
}
