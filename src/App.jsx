              ...
              <div style={{ marginTop: 8 }}>
                ...
                {satelliteClarityState.reading && (
                  <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "6px 0", borderBottom: "1px solid #16232E" }}>
                    ...
                    <span style={{ color: "#DCE8EE", fontSize: 12.5 }}>{satelliteClarityState.reading.label} · {satelliteClarityState.reading.ageHours}h old</span>
                  </div>
                )}
                <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "6px 0", borderBottom: "1px solid #16232E" }}>
...
function formatConditionsSummary(ei) {
  ...
  if (ei.satelliteClarity) {
    parts.push(`Satellite ${ei.satelliteClarity.label} (${ei.satelliteClarity.ageHours}h old)`);
  }
  return parts.join(" · ");
}
