        ...
        <div style={{ padding: "8px 14px" }}>
          {liveEntries.length === 0 ? (
            ...
            <>
              ...
              <div style={{ color: "#7590A0", fontSize: 11, fontFamily: "'Space Grotesk', sans-serif", letterSpacing: 0.5, marginBottom: 8 }}>
                SPECIES SCORES, WHY THEY DIFFER
              </div>
              {liveEntries
                ...
                .map(([sid, result]) => {
                  const sp = SPECIES.find((s) => s.id === sid);
                  return (
                    <div key={sid} style={{ background: "#0E1B26", border: "1px solid #1F3444", borderRadius: 10, padding: "10px 12px", marginBottom: 8 }}>
              ...
              <div style={{ color: "#4A6270", fontSize: 10.5, marginTop: 4, marginBottom: 10, lineHeight: 1.4 }}>
                Every species starts from the same live inputs above, weighted differently per species. Water clarity and bait presence aren't factored into these scores yet — see the Activity tab for real public reports instead.
              </div>
            </>
          )}
        </div>
