...
export function buildSpeciesFactors(species, presence, feedingResult, tempF, month, baitInfo, isNight) {
  const factors = [];
  const suit = tempSuitability(species, tempF);
...
export const MODEL_IMPLEMENTATION_FINGERPRINT = "5eea97a2f7ca51a0";
